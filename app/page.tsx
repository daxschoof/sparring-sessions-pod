...
export default function Home() {
  return (
    <div className="flex-1 bg-gradient-to-br from-[#eadabe] to-[#1d314e] from-30% content-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 h-screen w-screen">
      <div className="absolute top-4 right-4 rounded-3xl overflow-hidden max-sm:w-[100] max-sm:h-[100]">
        <Image
      ...
      <div className="flex flex-col items-center justify-center gap-20">
        <h1 className="max-sm:text-4xl text-6xl font-bold max-sm:font-extrabold text-[#1d324f] min-h-14 w-screen text-center overflow-hidden">
